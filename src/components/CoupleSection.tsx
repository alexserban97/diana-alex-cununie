    ...
    <section id="couple" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center items-center min-h-[60vh] px-4">
          <Card className="wedding-card p-8 text-center group hover:shadow-xl transition-all duration-300 max-w-3xl">
            <div className="mb-6">
            ...
            <h3 className="font-great-vibes text-2xl text-wedding-gold mb-6">
              Holiday romance turned forever
            </h3>

            <div className="text-gray-600 leading-relaxed text-left space-y-4">
              <p>
                Noi suntem Diana și Alex. Ne-am cunoscut în vara lui 2019 în Michigan, Statele Unite, iar primul nostru date a fost la Cascada Niagara – da, chiar acolo. Țin minte că și vorbeam: dacă primul date e aici, la următoarele trebuie să o duc pe lună cu Mustangul roșu, cu care am plimbat-o în vara aceea și care era împrumutat.
              </p>
